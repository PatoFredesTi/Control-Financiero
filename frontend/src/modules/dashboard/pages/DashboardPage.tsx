...
import { ArrowLeft, CalendarDays, CreditCard, Gauge, Goal, Landmark, PiggyBank, Scale, TrendingDown, TrendingUp } from 'lucide-react';
    ...
    <main className="min-h-screen bg-slate-950 px-6 py-8 text-slate-100">
      <section className="mx-auto max-w-7xl">
        ...
        <header className="mb-8 rounded-3xl border border-slate-800 bg-slate-900/70 p-8 shadow-2xl">
          <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-500/10 text-emerald-400"><Gauge size={30} /></div>
          <p className="mb-2 text-sm font-semibold uppercase tracking-[0.3em] text-emerald-400">v1.2 — Dashboard ampliado</p>
          <h1 className="text-4xl font-bold tracking-tight md:text-5xl">Dashboard financiero</h1>
          <p className="mt-4 max-w-3xl text-lg text-slate-300">Resumen de ingresos, gastos, deudas, presupuestos mensuales y metas de ahorro.</p>
        </header>
